 ...
 * Description: Приватний MCP-сервер для WordPress: власний ендпоінт поза REST API, персональні ключі з дзеркаленням ролей/прав WordPress, WP-CLI для адмінів (deny-list) + безпечні типізовані інструменти для контенту, Gutenberg-блоків, ACF, медіа, мультимовності, WooCommerce, мультивалютності та AIOSEO.
 * Version: 2.4.1
...
define('SIMPLE_MCP_VERSION', '2.4.1');
